!(function (a, b) {
  ...
  function i(a) {
    ...
    (b.settings = Object.assign({}, e, a || {})),
      ...
      r || ((r = document.createElement('div')), r.classList.add(c), r.classList.add(h('wrapper')), r.classList.add(h('is-initialized')), document.body.appendChild(r)),
      r.appendChild(i),
      (b.$wrapper = r),
      (b.$elem = i),
      j(b, 'opening'),
  ...
  return (
    ...
    (e = Object.assign({ position: 'center', type: 'info', showClose: !1, timeout: 2500, animation: !0, autoClose: !0, content: '', onClose: null, maxNums: 5, html: !1 }, a && a.QMSG_GLOBALS && a.QMSG_GLOBALS.DEFAULTS)),
    (f = {
